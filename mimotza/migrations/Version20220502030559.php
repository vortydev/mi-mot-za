 ...
 */
final class Version20220502030559 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE partie (id INT AUTO_INCREMENT NOT NULL, id_user_id INT NOT NULL, mot_id INT NOT NULL, win TINYINT(1) NOT NULL, score SMALLINT NOT NULL, temps TIME NOT NULL, date_emission DATETIME NOT NULL, INDEX IDX_59B1F3D79F37AE5 (id_user_id), INDEX IDX_59B1F3D63977652 (mot_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, id_role_id INT NOT NULL, id_statut_id INT NOT NULL, username VARCHAR(32) NOT NULL, email VARCHAR(255) NOT NULL, mdp VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, avatar VARCHAR(255) DEFAULT NULL, date_creation DATETIME NOT NULL, UNIQUE INDEX UNIQ_1D1C63B3F85E0677 (username), INDEX IDX_1D1C63B389E8BDC (id_role_id), INDEX IDX_1D1C63B376158423 (id_statut_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
